...
# Define accepted responses for "yes" and "no"
YES_RESPONSES = {"yes", "y", "yeah", "sure", "ok", "okay"}
NO_RESPONSES = {"no", "n", "nope", "nah"}
...
def chat():
    ...
    # If user says "yes", "y", etc., show medicines & precautions
    if user_input in YES_RESPONSES and "current_disease" in user_sessions[session_id]:
    ...
    # If user says "no", "n", etc., ask for another disease
